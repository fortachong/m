...
def st_features_frames(data_frame, window_size, sampling_rate):
...
def usage():
    print('python csv2acc_fft_dataset.py --ifile <input_file> --sr <sampling_rate> --w <window_size> --l <labels_file>')
    print()
    print('Example:')
    print('python csv2acc_fft_dataset.py --ifile data/ACC_capture.csv --sr 30 --w 2 --l datasets/labels.csv')
