"""
Generates a final csv with all the raw gps data and respective labels
...
def usage():
    print('python csv2gps.py --ifile <input_file> --l <labels_file>')
    print()
    print('Example:')
    print('python csv2gps.py --ifile data/GPS_capture.csv --l datasets/labels.csv')
