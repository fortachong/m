...
Outputs 2 files referring to a json file generated by API Sense Bee
...
GPS
tid: transaction id. One transaction is one single capture of many events. Events of type
        onLocationChanged
        authentication
header_timestamp:
point_id:
...
if __name__ == "__main__":
    ...
    ACC_f.write(ACC_header.encode('utf'))
