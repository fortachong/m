...
def usage():
    print('python train_svm_rbf_acc.py --ifile <input_file> --odir <output_directory>')
    print()
    print('Example:')
    print('python train_svm_rbf_acc.py --ifile datasets/ACC_capture.csv.30.2.features.csv --odir models')
