"""
Train using the dataset using Gradient Boosting
Toolkit used:
Scikit Learn
...
def usage():
    print('python train_gb_acc.py --ifile <input_file> --f <features_filename> --odir <output_directory>')
    print()
    print('Example:')
    print('python train_gb_acc.py --ifile datasets/ACC_capture.csv.30.2.features.csv --f models/features_1.txt --odir models')
...
if __name__ == "__main__":
    ...
    # Model File Name
    outputfile = fname + '.gb.model'
    # Confusion Matrix File Name
    cmfile = fname + '.gb.cm.eval.csv'
